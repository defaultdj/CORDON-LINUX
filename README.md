...
| Запуск игры | Нативный OpenXRay (`xr_3da`) + автоматический фолбэк на Proton/Wine при ошибках |
...
* **Windows PE (`xrEngine.exe`)**: CordonIX ищет установленный **Proton** (Steam / Proton GE) или **Wine** и запускает игру в нём.
